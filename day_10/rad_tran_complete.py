...
def Qeuv_function(SZA_in_deg,alts,temp):
    ...
    tau_o = calc_tau_complete(SZA_in_deg, density_o, h_o, euv_info['ocross'])
    tau_o2 = calc_tau_complete(SZA_in_deg, density_o2, h_o2, euv_info['o2cross'])
    tau_n2 = calc_tau_complete(SZA_in_deg, density_n2, h_n2, euv_info['n2cross'])
...
def Qeuv_function_with_rho(SZA_in_deg,alts,temp):
